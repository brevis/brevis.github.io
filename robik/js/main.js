...
function init() {
  ...
  // heavy generation after first paint
  setTimeout(() => {
    Tex.init();
    World.build();
...
function render() {
  ...
  for (const o of World.obstacles) {
    if (o.dead || o.noDraw || !vis(o.x, o.y, o.size + 20)) continue;
  ...
  drawList.length = 0;
  for (const o of World.obstacles) {
    if (o.dead || o.noDraw || o.canopy || !vis(o.x, o.y, o.size + 10)) continue;
    drawList.push(o);
  }
  ...
  for (const o of drawList) {
    if (o === G.player) Player.draw(ctx, o);
    else if (o.type) {
